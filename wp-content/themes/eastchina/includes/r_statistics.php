...
<li>评论总数：<?php echo $wpdb->get_var("SELECT COUNT(*) FROM $wpdb->comments where comment_author!='".(get_option('creekoo_user'))."'");?> 篇</li>
...
<li>建站日期：<?php echo get_option('creekoo_builddate'); ?></li>
<li>运行天数：<?php echo floor((time()-strtotime(get_option('creekoo_builddate')))/86400); ?> 天</li>
