...
<?php if (function_exists('is_tag')) { if ( is_tag() ) { ?><title><?php  single_tag_title("", true); ?> - <?php bloginfo('name'); ?><?php $paged = get_query_var('paged'); if ( $paged > 1 ) printf(' - 第 %s 页 ',$paged); ?></title><?php } ?><?php } ?>
...
<?php } ?>
<?php if ( is_home() ) { ?>
<meta name="description" content="<?php echo get_option('creekoo_description'); ?>" />
<meta name="keywords" content="<?php echo get_option('creekoo_keywords'); ?>" />
<?php } ?>
<?php if ( is_category() ) { ?>
